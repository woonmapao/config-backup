# Generated by Powerlevel10k configuration wizard on 2026-03-18 at 11:48 +07.
...
# concise, transient_prompt, instant_prompt=quiet (edited for faster/silent instant prompt).
...
() {
  ...
  # Lean right prompt: fewer segments means less work every refresh (major win vs default rainbow).
  ...
  # High voltage (U+26A1): reads well in any font; pairs with synthwave palette.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=39
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=39
